...
/opt/keycloak/bin/kc.sh start-dev --hostname-strict=false --https-certificate-file=/etc/x509/https/fullchain.pem --https-certificate-key-file=/etc/x509/https/privkey.pem &
